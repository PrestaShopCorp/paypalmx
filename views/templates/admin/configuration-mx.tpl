...
<div class="paypal_mx-module-wrapper">
	...
	<div class="paypal_mx-module-wrap">
		<div class="paypal_mx-module-col1-mx L">
		...
		<div class="paypal_mx-module-col1-mx R">
			...
			<img class="paypal_mx-cc" alt="" src="{$module_dir}/img/accpmark_tarjdeb_mx.png" style="margin-top: 15px;" />
		</div>
	</div>
	...
	<form action="{$paypal_mx_form_link|escape:'htmlall':'UTF-8'}" method="post">
		<fieldset>
			<legend><img src="{$module_dir}img/settings.gif" alt="" /><span>{l s='PayPal PayPal Express Checkout API Settings' mod='paypalmx'}</span></legend>
			...
			<div class="margin-form">
				<input type="text" name="paypal_mx_account" style="width: 250px;" value="{if $paypal_mx_configuration.PAYPAL_MX_ACCOUNT}{$paypal_mx_configuration.PAYPAL_MX_ACCOUNT|escape:'htmlall':'UTF-8'}{/if}" /> <sup>*</sup>
			</div>
			<label for="paypal_mx_api_username">{l s='PayPal API Username:' mod='paypalmx'}</label></td>
			<div class="margin-form">
				<input type="text" name="paypal_mx_api_username" style="width: 250px;" value="{if $paypal_mx_configuration.PAYPAL_MX_API_USERNAME}{$paypal_mx_configuration.PAYPAL_MX_API_USERNAME|escape:'htmlall':'UTF-8'}{/if}" /> <sup>*</sup>
			</div>
			<label for="paypal_mx_api_password">{l s='PayPal API Password:' mod='paypalmx'}</label></td>
			<div class="margin-form">
				<input type="password" name="paypal_mx_api_password" style="width: 250px;" value="{if $paypal_mx_configuration.PAYPAL_MX_API_PASSWORD}{$paypal_mx_configuration.PAYPAL_MX_API_PASSWORD|escape:'htmlall':'UTF-8'}{/if}" /> <sup>*</sup>
			</div>
			<label for="paypal_mx_api_signature">{l s='PayPal API Signature:' mod='paypalmx'}</label></td>
			<div class="margin-form">
				<input type="password" name="paypal_mx_api_signature" style="width: 250px;" value="{if $paypal_mx_configuration.PAYPAL_MX_API_SIGNATURE}{$paypal_mx_configuration.PAYPAL_MX_API_SIGNATURE|escape:'htmlall':'UTF-8'}{/if}" /> <sup>*</sup>
			</div>
			...
			<label for="paypal_mx_checkbox_product">{l s='Display button on' mod='paypalmx'}</label>
			...
			<label for="paypal_mx_checkbox_border_color">{l s='Button border color' mod='paypalmx'}</label></td>
			<div class="margin-form">
